...
-   [In Development] Each document (messages sub-collection) should have a 'recent' (messages) field. This will allows a single document read to initialize the state of the entire (message) view component on the front-end.
